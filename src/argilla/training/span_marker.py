...
class ArgillaSpanMarkerTrainer(ArgillaTrainerSkeleton):
    ...
    def init_model(self) -> None:
        self._framework_model = self._model_class.from_pretrained(**self.model_kwargs).to(self.device)
    ...
    def train(self, output_dir: str):
        ...
        # set trainer
        self._framework_trainer = Trainer(
    ...
    def predict(self, text: Union[List[str], str], as_argilla_records: bool = True, **kwargs):
        ...
        entities_list = self._framework_model.predict(text, **kwargs)
        ...
        if as_argilla_records:
            ...
            for sentence, entities in zip(text, entities_list):
                ...
                encoding = self._framework_model.tokenizer({"tokens": dataset["tokens"]}, return_batch_encoding=True)[
                    "batch_encoding"
                ]
