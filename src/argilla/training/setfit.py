...
class ArgillaSetFitTrainer(ArgillaTransformersTrainer):
    ...
    def train(self, output_dir: str = None):
        ...
        self._framework_model = SetFitModel.from_pretrained(**self.model_kwargs)
        self.trainer_kwargs["model"] = self._framework_model
        self._framework_trainer = SetFitTrainer(**self.trainer_kwargs)
    ...
    def predict(self, text: Union[List[str], str], as_argilla_records: bool = True, **kwargs):
        ...
        predictions = self._framework_model.predict_proba(text, **kwargs)
